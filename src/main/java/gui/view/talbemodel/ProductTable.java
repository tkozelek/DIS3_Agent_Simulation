...
public class ProductTable extends Table<Product> {
    ...
    public ProductTable() {
        super(new String[]{"OID", "ID", "Type", "Wid", "Stat", "Arr", "S Cut", "E Cut", "S Ver", "E Ver", "S Stain", "E Stain", "S Paint", "E Paint", "S Ass", "E Ass", "S Fit", "E Fit", "Fin"},
                List.of(
                        p -> p.getOrder().getId(),
                        Product::getId,
                        ...
                        w -> String.format("%s", Helper.timeToDateString(w.getStartVerifyParts(), 6)),
                        w -> String.format("%s", Helper.timeToDateString(w.getFinishVerifyParts(), 6)),
