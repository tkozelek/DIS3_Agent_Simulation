...
public class ProcessAssembly extends OSPABA.Process {
    ...
    private final ContinuosUniformGenerator assemblyTableGenerator;
    private final ContinuosUniformGenerator assemblyChairGenerator;
    private final ContinuosUniformGenerator assemblyCupboardGenerator;
